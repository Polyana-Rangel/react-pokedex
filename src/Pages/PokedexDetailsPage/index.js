          ...
          <Card1>
            ...
            <CardStats>
              ...
              <div className="progress">
                ...
                <ProgressBar backgroundColor={stats[0] && stats[0].base_stat > 50 ? '#f17400' : '#fff44e'} progress={stats[0] && stats[0].base_stat} />
              </div>

              <div className="progress">
                <p className="stats">Attack</p>
                <strong>{stats[1] && stats[1].base_stat}</strong>
                <ProgressBar backgroundColor={stats[1] && stats[1].base_stat > 50 ? '#f17400' : '#fff44e'} progress={stats[1] && stats[1].base_stat} />
              </div>

              <div className="progress">
                <p className="stats">Defense</p>
                <strong>{stats[2] && stats[2].base_stat}</strong>
                <ProgressBar backgroundColor={stats[2] && stats[2].base_stat > 50 ? '#f17400' : '#fff44e'} progress={stats[2] && stats[2].base_stat} />
              </div>

              <div className="progress">
                <p className="stats">Sp. Atk</p>
                <strong>{stats[3] && stats[3].base_stat}</strong>
                <ProgressBar backgroundColor={stats[3] && stats[3].base_stat > 50 ? '#f17400' : '#fff44e'} progress={stats[3] && stats[3].base_stat} />
              </div>

              <div className="progress">
                <p className="stats">Sp. Def</p>
                <strong>{stats[4] && stats[4].base_stat}</strong>
                <ProgressBar backgroundColor={stats[4] && stats[4].base_stat > 50 ? '#f17400' : '#fff44e'} progress={stats[4] && stats[4].base_stat} />
              </div>

              <div className="progress">
                <p className="stats">Speed</p>
                <strong>{stats[5] && stats[5].base_stat}</strong>
                <ProgressBar backgroundColor={stats[5] && stats[5].base_stat > 50 ? '#f17400' : '#fff44e'} progress={stats[5] && stats[5].base_stat} />
              </div>
              <div className="progress">
                <p className="stats">Total</p>
                <strong id="total"> {totalStats()}
                </strong>
                <ProgressBar backgroundColor="red" progress={0} />
